			...
			<div class="box">
			 <div class="box_1">
			  <div class="userCenterBox boxCenterList clearfix" style="_height:1%;">
				...
				<table bgcolor="#dddddd" border="0" cellpadding="5" cellspacing="1" width="100%">
					<tbody><tr>
					  <td bgcolor="#ffffff" width="15%">充值金额:</td>
					  <td align="left" bgcolor="#ffffff"><input name="amount" class="inputBg" size="30" type="text"></td>
					</tr>
					<tr>
				  ...
				  <table bgcolor="#dddddd" border="0" cellpadding="5" cellspacing="1" width="100%">
					<tbody><tr align="center">
					  <td colspan="3" align="left" bgcolor="#ffffff">支付方式:</td>
					</tr>
					<tr align="center">
					  ...
					  <input name="payment_id" value="4" type="radio">支付宝</td>
					  <td align="left" bgcolor="#ffffff">支持阿里巴巴旗下支付宝账号支付、以及国内各主要银行的网上银行服务。如果您的银行卡已开通网上银行功能，选择此项可自助在线购买课程，系统自动开通课程！</td>
					  <td align="center" bgcolor="#ffffff">0</td>
					</tr>
								<tr>
				<td colspan="3" align="center" bgcolor="#ffffff">
				<input name="surplus_type" value="0" type="hidden">
				  <input name="rec_id" value="" type="hidden">
				  <input name="act" value="act_account" type="hidden">
				  <input class="bnt_blue_1" name="submit" value="提交申请" type="submit">
				  <input class="bnt_blue_1" name="reset" value="重置表单" type="reset">
				</td>
			  </tr>
				  </tbody></table>
				</form>
